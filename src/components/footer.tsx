        ...
        <footer className="mt-4 pb-6 text-zinc-400 md:space-y-2 bottom-0">
            ...
            <div className="lg:grid lg:grid-cols-4 space-y-2 lg:space-y-0">
                <div className="lg:col-span-3 space-y-2 lg:space-y-0">
                    <div className="flex flex-wrap">{dict.footer.build_with} <HeartIcon className="h-5 w-5 mr-1 ml-1 text-red-700" /> <p className="mr-1 md:mr-0">{dict.footer.by_team_and}</p> <Link className="md:ml-1" href={"/" + dict.lang + "/legal/contributer"}>{dict.footer.contributers}</Link>.</div>
