        ...
        <div className="min-h-screen 3xl:grid content-center">
            <div className="text-center">
                <div className='block lg:hidden'>
                    <Image src={"/company/slynite-logo-gradient.png"} alt="Slynite Logo" width={1920} height={1080} layout="responsive" placeholder="blur"  blurDataURL={"/company/slynite-logo-gradient.png"} />
                </div>
                <div className='hidden lg:block'>
                    <Image src={"/company/slynite-banner-v2.png"} alt="Slynite Logo" width={1920} height={500} layout="responsive" placeholder="blur" blurDataURL={"/company/slynite-banner-v2.png"} />
                </div>
