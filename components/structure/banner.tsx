...
export default function Banner() {
  if (process.env.NEXT_PUBLIC_IS_BANNER_ACTIVE === "true") {
      return (
        <div className="backgroundPattern outline outline-1 outline-customGray rounded-md mb-8">
        <div className="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between flex-wrap">
            <div className="w-0 flex-1 flex items-center">
              <span className="flex p-2 rounded-lg bg-neutral-850 outline outline-1 outline-customGray">
            ...
            <div className="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
              <Link
                href={'/newsroom/slynite-com-relaunch'}
                passHref
                className="text-sm font-mediumtext-white"
                legacyBehavior>
